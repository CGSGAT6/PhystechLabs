...
и можно сказать, что они близки к табличному значению вязкости касторового масла при комнатной температуре (около $0.960\text{ Па}\cdot\text{с}$) 
относительная погрешность результатов небольшая $\varepsilon_{ \eta} < 5\%$.
